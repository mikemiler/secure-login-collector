    ...
    public function frontend_form_shortcode($atts)
    {
        ...
        <div class="secure-login-form-container">
            ...
            <div class="security-info">
                ...
                if ($text_type === 'custom' && !empty($custom_text)) :
                ...
                <?php else: ?>
                    ...
                    <?php if ($expiration_days > 0) : ?>
                        <p><strong><?php echo esc_html__('Security & Privacy:', 'secure-login-collector'); ?></strong> <?php echo sprintf(esc_html__('Your data is encrypted in your browser before being sent to our server. We store the encrypted data securely for %d days, after which it will be automatically deleted.', 'secure-login-collector'), $expiration_days); ?></p>
                    <?php else: ?>
